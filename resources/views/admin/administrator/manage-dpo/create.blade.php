...
<div id="AddModal" class="hidden fixed inset-0 z-50 bg-black/50 items-center justify-center px-4">
    <div class="bg-white rounded-xl shadow-lg w-full max-w-lg p-6 relative">
        ...
        <!-- Form Create -->
        <form id="addJabatanForm" method="POST" action="{{ route('manage-dpo.store') }}">
            @csrf
            ...
            <div class="mb-4">
                ...
                <input type="text" name="nama" id="nama"
                    ...
                    placeholder="Contoh: Koordinator, Sekretaris , Komisi, dsb."
                    required>
                <p class="text-xs text-gray-500 mt-1">
                    Nama Jabatan Tidak Boleh Disingkat. Contoh: Koordinator, Sekretaris , Komisi, dsb.
                </p>
            </div>
