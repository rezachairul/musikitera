<x-admin.bph.layouts>
    ...
    <div class="bg-white rounded-xl border border-gray-200 p-3 sm:p-6 m-3 sm:m-6 shadow-sm">
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-4 sm:mb-6 gap-3 sm:gap-2">
            ...
            <div>
                ...
                <p class="text-gray-600 mt-1 text-sm">
                    Pengelolaan data {{ $title }} untuk menata informasi mitra internal maupun eksternal.
                </p>
            </div>
            ...
            <div class="min-w-full inline-block align-middle">
                <div class="overflow-hidden border border-gray-200 sm:rounded-lg">
                    <table class="min-w-full divide-y divide-gray-200">
                        ...
                        <tbody id="ManageMitraTableBody" class="bg-white divide-y divide-gray-200">
                            @include('admin.bph.kerjasama_mitra.mitra.partials.table_body')
                        </tbody>
        ...
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-6 gap-4 pt-4">
            ...
            <div class="text-sm text-gray-500 text-center sm:text-left">
                Menampilkan 
                <span class="font-medium">{{ $mitras->firstItem() }}</span> 
                sampai 
                <span class="font-medium">{{ $mitras->lastItem() }}</span> 
                dari 
                <span class="font-medium">{{ $mitras->total() }}</span> {{ $title }}
            </div>
    ...
    <!-- Modals -->
    @include('admin.bph.kerjasama_mitra.mitra.create')
    @include('admin.bph.kerjasama_mitra.mitra.update')
    @include('admin.bph.kerjasama_mitra.mitra.delete')
