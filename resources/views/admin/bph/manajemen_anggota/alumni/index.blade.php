<x-admin.bph.layouts>
    ...
    <div class="bg-white rounded-xl border border-gray-200 p-3 sm:p-6 m-3 sm:m-6 shadow-sm">
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-4 sm:mb-6 gap-3 sm:gap-2">
            ...
            <div class="mb-6">
                ...
                <p class="text-gray-600 mt-1 text-sm">
                    ...
                    Alumni adalah jejak perjalanan yang membentuk organisasi <br> dan inspirasi bagi anggota aktif.
                </p>
            </div>
            ...
            <div class="flex flex-col sm:flex-row gap-2">
                ...
                <!-- Export -->
                 <a href="{{ route('manage-alumni.export', [
            ...
            <div class="flex flex-col gap-3 mb-4 sm:flex-row sm:items-center sm:justify-between">
                ...
                <div class="relative w-full sm:w-1/3">
                    ...
                    <input 
                        ...
                        data-url="{{ route('manage-alumni.index') }}"
                        data-target="AlumniTableBody"
                ...
                <div class="overflow-hidden border border-gray-200 sm:rounded-lg">
                    <table class="min-w-full divide-y divide-gray-200">
                        ...
                        <tbody id="AlumniTableBody" class="bg-white divide-y divide-gray-200">
                            @include ('admin.bph.manajemen_anggota.alumni.partials.table_body')
                        </tbody>
                        <tfoot class="bg-gray-50">
                            <tr>
                                <td colspan="7" class="px-6 py-3 text-sm text-gray-700">
                                    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2">
                                        <span>Total Anggota: <span class="font-semibold"></span></span>
        ...
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-6 gap-4 pt-4">
            ...
            <div class="text-sm text-gray-500 text-center sm:text-left">
                Menampilkan 
                <span class="font-medium">{{ $alumnis->firstItem() ?? 0 }}</span> 
                sampai 
                <span class="font-medium">{{ $alumnis->lastItem() ?? 0 }}</span> 
                dari 
                <span class="font-medium">{{ $alumnis->total() }}</span> {{ $title }}
            </div>
            ...
            <div class="flex justify-center sm:justify-end">
                <nav class="inline-flex space-x-1 sm:space-x-2" aria-label="Pagination">
                    ...
                    @foreach ($alumnis->links()->elements[0] ?? [] as $page => $url)
    ...
    <!-- Modals -->
     @include('admin.bph.manajemen_anggota.alumni.create')
     @include('admin.bph.manajemen_anggota.alumni.update')
     @include('admin.bph.manajemen_anggota.alumni.delete')
