...
<tr class="hover:bg-gray-50 text-left text-xs">
    ...
    <td class="px-6 py-4 whitespace-nowrap">
        @php
            $roleInfo = $roleLabels[$anggota_aktif->role] ?? ['label' => ucfirst($anggota_aktif->role), 'color' => 'bg-gray-100 text-gray-700 border border-gray-300'];
        @endphp
    ...
    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-center align-middle">
        ...
        <div class="flex justify-center items-center h-full space-x-2">
            @if(in_array($anggota_aktif->email, $defaultEmails))
                <!-- Disabled Icon -->
