<x-admin.bph.layouts>
    ...
    <div class="bg-white rounded-xl border border-gray-200 p-3 sm:p-6 m-3 sm:m-6 shadow-sm">
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-4 sm:mb-6 gap-3 sm:gap-2">
            ...
            <div>
                ...
                <p class="text-gray-600 mt-1 text-sm">
                    Digunakan untuk menata dan menampilkan gambar utama sebagai identitas organisasi.
                </p>
            </div>
            ...
            <div class="flex flex-col sm:flex-row gap-2">
                ...
                <!-- Export -->
                 <a href="{{ route('manage-galeri.export', [
                ...
                <div class="overflow-hidden border border-gray-200 sm:rounded-lg">
                    <table class="min-w-full divide-y divide-gray-200">
                        ...
                        <tbody id="ManageGaleriTableBody" class="bg-white divide-y divide-gray-200">
                            @include('admin.bph.manajemen_konten.galeri.partials.table_body')
                        </tbody>
                        <tfoot class="bg-gray-50">
                            <tr>
                                <td colspan="6" class="px-6 py-3 text-sm text-gray-700">
                                    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2">
                                        <span>Total {{$title}}: <span class="font-semibold">{{ $totalGaleris }}</span></span>
                                    </div>
                                </td>
                            </tr>
                        </tfoot>
        ...
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-6 gap-4 pt-4">
            ...
            <div class="text-sm text-gray-500 text-center sm:text-left">
                ...
                dari 
                <span class="font-medium">{{ $galeris->total() }}</span> {{ $title }}
            </div>
    ...
    <!-- Modals -->
    @include('admin.bph.manajemen_konten.galeri.create')
    @include('admin.bph.manajemen_konten.galeri.update')
    @include('admin.bph.manajemen_konten.galeri.delete')
