<x-admin.bph.layouts>
    ...
    <div class="bg-white rounded-xl border border-gray-200 p-3 sm:p-6 m-3 sm:m-6 shadow-sm">
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-4 sm:mb-6 gap-3 sm:gap-2">
            ...
            <div>
                ...
                <p class="text-gray-600 mt-1 text-sm">
                    Digunakan untuk menata dan menampilkan kegiatan organisasi.
                </p>
            </div>
            ...
            <div class="flex flex-col sm:flex-row gap-2">
                ...
                <!-- Export -->
                 <a href="{{ route('manage-kegiatan.export', [
        ...
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-6 gap-4 pt-4">
            ...
            <div class="text-sm text-gray-500 text-center sm:text-left">
                Menampilkan 
                <span class="font-medium">{{ $kegiatans->firstItem() }}</span> 
                sampai 
                <span class="font-medium">{{ $kegiatans->lastItem() }}</span> 
                dari 
                <span class="font-medium">{{ $kegiatans->total() }}</span> {{ $title }}
            </div>
    ...
    <!-- Modals -->
    @include('admin.bph.publikasi_informasi.kegiatan.create')
    @include('admin.bph.publikasi_informasi.kegiatan.update')
    @include('admin.bph.publikasi_informasi.kegiatan.delete')
