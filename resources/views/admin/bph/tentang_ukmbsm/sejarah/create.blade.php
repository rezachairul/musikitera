...
<div id="AddModal" class="hidden fixed inset-0 z-50 bg-black/50 items-center justify-center px-4">
    <div class="bg-white rounded-xl shadow-lg w-full max-w-2xl p-6 relative">
        ...
        <div class="max-h-[80vh] overflow-y-auto px-4 py-2">
            <form id="addForm" method="POST" action="{{ route('manage-sejarah.store') }}" enctype="multipart/form-data">
                @csrf
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="col-span-2">
                        ...
                        placeholder="Tulis deskripsi organisasi..."></textarea>
                    </div>
                    ...
                    <div class="col-span-1">
                        ...
                        <input type="datetime-local" name="tahun_mulai" id="tahun_mulai" class="w-full px-3 py-2 border border-gray-200 rounded-lg focus:ring-2 focus:ring-blue-500">
                    </div>
                    ...
                    <div class="col-span-1">
                        ...
                        <input type="datetime-local" name="tahun_akhir" id="tahun_akhir" class="w-full px-3 py-2 border border-gray-200 rounded-lg focus:ring-2 focus:ring-blue-500">
                    </div>

                    <!-- Logo UKM (full width di bawah quotes) -->
                    <div class="col-span-1 md:col-span-2">
                        <label for="logo_input" class="block text-sm font-medium text-gray-700 mb-2">
                            Logo UKM <span class="text-xs text-gray-500">(Format: JPG, JPEG, PNG • Maks 2MB)</span>
                        </label>
