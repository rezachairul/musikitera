...
<div id="AddModal" class="hidden fixed inset-0 z-50 bg-black/50 items-center justify-center px-4">
    <div class="bg-white rounded-xl shadow-lg w-full max-w-2xl p-6 relative">
        ...
        <form method="POST" action="{{ route('manage-studio-musik.facilities.store') }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input type="text" name="nama" required class="w-full px-3 py-2 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500" placeholder="Contoh: Drum Set">
                </div>
                ...
                <div>
                    ...
                    <input type="number" name="urutan" class="w-full px-3 py-2 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500" placeholder="Contoh: 1" >
                </div>
                ...
                <div class="md:col-span-2">
                    ...
                    <textarea name="deskripsi" rows="3" class="w-full px-3 py-2 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500" placeholder="Deskripsi singkat fasilitas" ></textarea>
                </div>
                ...
                <div class="col-span-1 md:col-span-2">
                    ...
                    <div class="flex flex-col md:flex-row items-start md:items-center space-y-3 md:space-y-0 md:space-x-4">
                        ...
                        <!-- File input -->
                        <input id="image_input" name="image" type="file" accept=".jpg,.jpeg,.png" class="hidden"
