<div class="w-64 bg-white shadow-lg text-gray-800 flex flex-col h-screen">
    ...
    <nav class="flex-1 overflow-y-auto p-5 space-y-2" x-data="{ openMenu: null }">
        ...
        <div>
            <button @click="openMenu = (openMenu === 'about' ? null : 'about')" class="w-full flex items-center justify-between px-3 py-2 rounded-md transition-colors {{ request()->routeIs('manage-hero.*') || request()->routeIs('manage-profile.*') || request()->routeIs('manage-visi-misi.*') || request()->routeIs('manage-sejarah.*') ? 'bg-gray-100 text-amber-600 font-medium' : 'text-gray-700 hover:bg-gray-100 hover:text-amber-600' }}">
                ...
                <svg xmlns="http://www.w3.org/2000/svg" class="size-4 transition-transform" :class="{ 'rotate-180': openMenu === 'about' }" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"/>
                </svg>
            </button>
        ...
        <div>
            <button @click="openMenu = (openMenu === 'publikasi' ? null : 'publikasi')" class="w-full flex items-center justify-between px-3 py-2 rounded-md transition-colors {{ request()->routeIs('manage-dokumen.*') || request()->routeIs('manage-kegiatan.*') || request()->routeIs('manage-pengumuman.*')  ? 'bg-gray-100 text-amber-600 font-medium'  : 'text-gray-700 hover:bg-gray-100 hover:text-amber-600' }}">
                <div class="flex items-center gap-3">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
            ...
            <div x-show="openMenu === 'publikasi'" x-cloak 
                ...
                <a href="{{ route('manage-dokumen.index') }}" class="px-3 py-1 rounded-md transition-colors  {{ request()->routeIs('manage-dokumen.*') ? 'text-amber-600 font-medium bg-gray-100' : 'text-gray-600 hover:text-amber-600' }}">
                    Dokumen
                </a>
                <a href="{{ route('manage-kegiatan.index') }}" class="px-3 py-1 rounded-md transition-colors  {{ request()->routeIs('manage-kegiatan.*') ? 'text-amber-600 font-medium bg-gray-100' : 'text-gray-600 hover:text-amber-600' }}">
                    Kegiatan
                </a>
                <a href="{{ route('manage-pengumuman.index') }}" class="px-3 py-1 rounded-md transition-colors  {{ request()->routeIs('manage-pengumuman.*') ? 'text-amber-600 font-medium bg-gray-100' : 'text-gray-600 hover:text-amber-600' }}">
                    Pengumuman Penting
                </a>
            </div>
        </div>
