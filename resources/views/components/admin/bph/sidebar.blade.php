    ...
    <nav class="flex-1 overflow-y-auto p-5 space-y-2" x-data="{ openMenu: null }">
        ...
        <div>
            <button @click="openMenu = (openMenu === 'publikasi' ? null : 'publikasi')"
                ...
                <svg xmlns="http://www.w3.org/2000/svg" class="size-4 transition-transform" :class="{ 'rotate-180': openMitra }" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"/>
                </svg>
            </button>
