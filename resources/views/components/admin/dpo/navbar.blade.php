    ...
    <div class="w-full max-w-7xl mx-auto px-4 md:px-6 py-3 flex items-center justify-end space-x-6">
        ...
        <button id="dark-toggle" class="focus:outline-none relative w-6 h-6">
            ...
            <svg id="icon-sun" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                stroke="currentColor" class="absolute inset-0 size-6 block icon-transition">
                <path stroke-linecap="round" stroke-linejoin="round"
            ...
            <svg id="icon-moon" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                stroke="currentColor" class="absolute inset-0 size-6 hidden icon-transition">
                <path stroke-linecap="round" stroke-linejoin="round"
            ...
            <div
                ...
                <div class="px-4 py-3 border-b space-y-2">
                    ...
                    @php
                        ...
                        $roleData = $roleLabels[$userRole] ?? [
                            'label' => ucfirst($userRole),
                    ...
                    <div class="flex items-center gap-2">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                            ...
                            <path stroke-linecap="round" stroke-linejoin="round"
                                d="M9 12.75 11.25 15 15 9.75m-3-7.036A11.959  11.959 0 0 1 3.598 6 11.99 11.99 0 0 0  3 9.749c0 5.592 3.824 10.29 9  11.623 5.176-1.332 9-6.03  9-11.622 0-1.31-.21-2.571-.598-3.751h-.152 c-3.196 0-6.1-1.248-8.25-3.285Z" />
                        </svg>
