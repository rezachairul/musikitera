<footer class="bg-gray-900 text-gray-300 py-10 mt-12">
    <div class="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-3 gap-8 text-center md:text-left">
        ...
        <div class="flex justify-center md:justify-start space-x-4">
            <a href="https://instagram.com/musikitera" class="hover:text-yellow-500" aria-label="Instagram">
            ...
            <a href="https://www.youtube.com/@musikitera5519" class="hover:text-yellow-500" aria-label="YouTube">
                <svg class="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
    ...
    <div class=" border-gray-700 mt-8 pt-4 text-center text-sm text-gray-500">
        &copy; {{ date('Y') }} UKMBSM ITERA. All rights reserved.

        <div class="mt-2">
            Proyek ini dikembangkan oleh:
            <br>
            🐍 <a href="https://cobradev.vercel.app/" target="_blank" rel="noopener noreferrer" class="text-gray-400 hover:text-yellow-500 font-medium">
                CobraDev
            </a>
            &nbsp;|&nbsp;
            🌐 <a href="https://sigawariweb.netlify.app/" target="_blank" rel="noopener noreferrer" class="text-gray-400 hover:text-yellow-500 font-medium">
                Sigawari
            </a>
        </div>
    </div>
