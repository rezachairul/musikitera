<x-errors.layouts>
    <x-slot:title>{{ $title ?? '404 - Panggung Hilang' }}</x-slot:title>
    ...
    <div class="min-h-screen flex items-center justify-center relative overflow-hidden"
        ...
        <div class="relative z-10 text-center px-6 py-12 max-w-lg w-full">
            ...
            <div
                ...
                <h1 class="text-8xl font-black text-white italic tracking-tighter opacity-90"
                    style="text-shadow: 4px 4px 0px #b45309;">404</h1>

                <div class="h-1 w-full border-b-2 border-dashed border-amber-600/40 my-6"></div>

                <p class="text-2xl font-bold text-amber-500 uppercase tracking-widest italic">Panggung Hilang 🧭</p>
                <p class="text-blue-100/60 mt-4 leading-relaxed italic">
                    "I’m not looking for a way out..." <br>
                    Maaf, halaman yang kamu cari nggak ada di peta backstage kami.
                </p>
                ...
                <div
                    ...
                    Now Playing: Lost in the Backstage - 404 Mix
                </div>
            </div>
        </div>
        ...
        <audio id="bgMusic" loop>
            <source src="{{ asset('music/lost-in-the-backstage.mp3') }}" type="audio/mpeg">
