...
<x-errors.layouts>
    <x-slot:title>{{ $title ?? '419 - Page Expired' }}</x-slot:title>
    ...
    <div class="min-h-screen flex items-center justify-center relative overflow-hidden"
        ...
        <div class="relative z-10 text-center px-6 py-12 max-w-lg w-full">
            ...
            <div
                ...
                <h1 class="text-8xl font-black text-white italic tracking-tighter opacity-90"
                    style="text-shadow: 4px 4px 0px #b45309;">419</h1>

                <div class="h-1 w-full border-b-2 border-dashed border-amber-600/40 my-6"></div>

                <p class="text-2xl font-bold text-amber-500 uppercase tracking-widest italic">Page Expired 🎶</p>
                <p class="text-blue-100/60 mt-4 leading-relaxed italic">
                    "Sepertinya tempo-nya habis..." <br>
                    Sesi atau token kamu sudah kedaluwarsa. Silakan refresh halaman atau login lagi.
                </p>
                ...
                <div
                    ...
                    Now Playing: Kembali Pulang - 419 Session Cut
                </div>
            </div>
        </div>
        ...
        <audio id="bgMusic" loop>
            <source src="{{ asset('music/kembali-pulang.mp3') }}" type="audio/mpeg">
