<!-- Too Many Requests (rate limit, kalau user spam request API) -->
<x-errors.layouts>
    <x-slot:title>{{ $title ?? '429 - Terlalu Banyak Permintaan' }}</x-slot:title>
    ...
    <div class="min-h-screen flex items-center justify-center relative overflow-hidden"
        ...
        <div class="relative z-10 text-center px-6 py-12 max-w-lg w-full">
            ...
            <div
                ...
                <h1 class="text-8xl font-black text-white italic tracking-tighter opacity-90"
                    style="text-shadow: 4px 4px 0px #b45309;">429</h1>

                <div class="h-1 w-full border-b-2 border-dashed border-amber-600/40 my-6"></div>

                <p class="text-2xl font-bold text-amber-500 uppercase tracking-widest italic">Terlalu Banyak Permintaan ⏳
                </p>
                <p class="text-blue-100/60 mt-4 leading-relaxed italic">
                    "Sabar ya, antri dulu..." <br>
                    Kamu terlalu sering request dalam waktu singkat. Tunggu sebentar, lalu coba lagi.
                </p>
                ...
                <div
                    ...
                    Now Playing: Hati-Hati di Jalan - Tulus
                </div>
            </div>
        </div>
        ...
        <audio id="bgMusic" loop>
            <source src="{{ asset('music/hati-hati-di-jalan-tulus.mp3') }}" type="audio/mpeg">
