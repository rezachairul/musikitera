...
<x-errors.layouts>
    <x-slot:title>{{ $title ?? '500 - Internal Server Error' }}</x-slot:title>
    ...
    <div class="min-h-screen flex items-center justify-center relative overflow-hidden"
        ...
        <div class="relative z-10 text-center px-6 py-12 max-w-lg w-full">
            ...
            <div
                ...
                <h1 class="text-8xl font-black text-white italic tracking-tighter opacity-90"
                    style="text-shadow: 4px 4px 0px #b45309;">500</h1>

                <div class="h-1 w-full border-b-2 border-dashed border-amber-600/40 my-6"></div>

                <p class="text-2xl font-bold text-amber-500 uppercase tracking-widest italic">Server Error 🎹</p>

                <p class="text-blue-100/60 mt-4 leading-relaxed italic">
                    "Oops, ada kesalahan di server." <br>
                    Sepertinya ada nada yang patah, coba lagi nanti.
                </p>

                <p class="text-blue-100/50 mt-4 leading-relaxed italic">
                    "Oops, something went wrong on our server." <br>
                    It sounds like a note snapped—please try again later.
                </p>
        ...
        <audio id="bgMusic" loop>
            <source src="{{ asset('music/track-510-broken-note.mp3') }}" type="audio/mpeg">
