<x-public.layouts>
    <x-slot:title>Contact - External & Global Inquiry</x-slot:title>
    ...
    <div class="relative min-h-screen bg-white py-8 md:py-16 overflow-hidden font-sans">
        ...
        <div class="max-w-6xl mx-auto px-4 sm:px-6 relative z-10">
                ...
                <div
                    ...
                    <div class="flex items-center gap-3">
                        <div class="relative flex h-3 w-3">
                            {{-- Status dot tetap merah untuk menandakan 'External/Live' tapi elemen interaksi tetap Navy --}}
                            <span
                                class="animate-ping absolute inline-flex h-full w-full rounded-full bg-[#E63946] opacity-20"></span>
                            <span class="relative inline-flex rounded-full h-3 w-3 bg-[#E63946]"></span>
                        </div>
                        <span
                            class="text-[10px] md:text-[11px] font-black tracking-[0.3em] md:tracking-[0.4em] text-[#457B9D] uppercase leading-none">
                            Global Inquiry // External Track
                        </span>
                    </div>
                    <div
                        class="text-[9px] md:text-[10px] font-bold text-slate-300 tracking-widest uppercase italic text-center sm:text-right">
                        Frequency: 105.4 World FM // ITERA Music Unit
                    </div>
                </div>
                    ...
                    <div
                        ...
                        <div
                            ...
                            <div
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg" class="w-12 h-12 text-[#457B9D] mb-4 z-10"
                                ...
                                <div class="absolute bottom-6 sm:bottom-8 flex gap-1.5 h-6 items-end z-10">
                                    <div class="w-1 bg-[#E63946] h-3 animate-bounce"></div>
                                    <div class="w-1 bg-[#457B9D] h-6 animate-bounce [animation-delay:0.2s]"></div>
                                    <div class="w-1 bg-white h-4 animate-bounce [animation-delay:0.4s]"></div>
                                    <div class="w-1 bg-[#E63946] h-2 animate-bounce [animation-delay:0.1s]"></div>
                                </div>
                            </div>
                            {{-- Vinyl --}}
                            <div
                                ...
                                <div
                                    ...
                                    <div
                                        class="w-4 h-4 bg-[#E63946] rounded-full border border-white/10 shadow-[0_0_10px_rgba(230,57,70,0.5)]">
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div
                            ...
                            <div class="max-w-xl mx-auto lg:mx-0">
                                ...
                                <h2
                                    class="text-3xl md:text-5xl font-black text-[#0A192F] mb-4 md:mb-6 tracking-tighter leading-[0.9] uppercase">
                                    HUBUNGI KAMI<br class="hidden sm:block"> <span class="text-[#457B9D]">/
                                        CONNECT.</span></h2>

                                <p class="text-base md:text-lg text-slate-500 font-medium leading-relaxed mb-8">
                                    Punya ide kolaborasi, pertanyaan, atau sekadar ingin berbagi cerita musikmu?
                                    <span class="text-[#0A192F] font-bold">Silakan hubungi kami melalui kanal global
                                        kami.</span>
                                </p>
                    ...
                    <div class="flex flex-col sm:flex-row items-center gap-6 md:gap-8">
                        ...
                        <div class="hidden sm:block">
                            <div class="flex items-center gap-3 mb-1">
                                <span class="text-[10px] font-black text-[#0A192F] uppercase">Live</span>
                                <div class="w-32 md:w-48 h-[2px] bg-slate-200 rounded-full relative">
                                    <div class="absolute top-0 right-0 h-full w-2/3 bg-[#E63946]"></div>
                                </div>
                                <span class="text-[10px] font-black text-slate-400">Globe</span>
                            </div>
                        </div>
                    </div>
                    <div class="text-center md:text-right">
                        <p
                            class="text-[9px] md:text-[10px] font-black text-[#457B9D] uppercase tracking-widest leading-none mb-1">
                            Now Tuning</p>
                        <p class="text-xs md:text-sm font-bold text-[#0A192F] tracking-tight italic">International
                            Collaboration — ITERA</p>
                    </div>
                </div>
            </div>
            ...
            <p
                ...
                World Wide Collaboration // Unit Kegiatan Mahasiswa Seni Musik ITERA
            </p>
        </div>
    </div>
</x-public.layouts>
